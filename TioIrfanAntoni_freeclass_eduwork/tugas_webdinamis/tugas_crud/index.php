          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-7 text-align-right">
                         ...
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 08.00 - 18:00 (Setiap Hari)</span>
                    </div>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li class="btn btn-info"><a href="admin/index.php">Data</a></li>
                    </ul>
               </div>
...
$queryy = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT no_antrian FROM pendaftaran WHERE tgl_pendaftaran = '$tgl_pendaftaran'");
$htg = mysqli_num_rows($queryy);

$next = $htg + 1;

$no_antrian = $tgl_pendaftaran . '/' . $next;

$hitung = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT max(id_customer) as id_terakhir from customer");
$cari = mysqli_fetch_array($hitung);
                         ...
                         <form id="appointment-form" role="form" method="post" action="pages/proses_pendaftaran.php">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <?php
$result2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from type_mobil");
...
?>
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <?php
$result = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jenis_cucian");
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                         <div class="col-md-6 col-sm-6">
                              <div class="copyright-text">
                                   <p>Copyright &copy; <?= date('Y');?> <a href="https://instagram.com/si_tyoy"><b> Gas </b></a>
                                   </p>
                              </div>
                         </div>
