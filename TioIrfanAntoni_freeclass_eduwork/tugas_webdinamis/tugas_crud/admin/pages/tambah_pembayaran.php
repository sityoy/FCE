...
$queryy = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pendaftaran join customer using(id_customer) join jenis_cucian using (id_jenis_cucian) WHERE id_pendaftaran = '$id_pendaftaran'"); //get the data that will be updated
    ...
    <input type="hidden" id="text-input" name="status" class="form-control" value="Lunas">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            $sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT no_nota FROM transaksi");
