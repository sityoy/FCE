...
$cek = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count(id_pendaftaran) as jumlah_daftar FROM pendaftaran WHERE jam_pendaftaran = '$jam_pendaftaran'");
$htg = mysqli_fetch_array($cek);
...
$hasill = mysqli_query($GLOBALS["___mysqli_ston"], $queryy);
