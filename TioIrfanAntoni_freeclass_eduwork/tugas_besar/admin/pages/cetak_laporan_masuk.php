...
<table border="1" width="100%">
    ...
    <tbody>
        <?php
            $no = 1;
            $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from tbl_surat_masuk join tbl_user using (id_user) where month(tgl_diterima) = '$bulan' and year(tgl_diterima) = '$tahun'");
